				...
				<table class="table striped">
					...
					<?php if(!empty($vodici)): foreach($vodici as $vodic): ?>
						<tr>
							...
							<td>
								<a href="<?php echo site_url('vodici/view/'.$vodic['id_vodici']); ?>"class="glyphicon glyphicon-eye-open"></a>
								<a href="<?php echo site_url('vodici/edit/'.$vodic['id_vodici']); ?>"class="glyphicon glyphicon-edit"></a>
								<a href="<?php echo site_url('vodici/delete/'.$vodic['id_vodici']); ?>"class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure to delete?')"></a>
							</td>
						</tr>
					<?php endforeach; else: ?>
