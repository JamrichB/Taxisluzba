...
<div class="container">
	...
	<div class="row">
		...
		<input style="margin-bottom: 10px; margin-left: 15px; width: 200px" type="text" id="myInput" onkeyup="myFunction()" placeholder="Vyhľadajte vodiča podľa priezviska" title="Type in a name">
	</div>
	<div class="row">
		<div class="col-xs-12">
